...
(b) it is necessary for calculating and billing interconnection payments or for the
    ...
    billing, detecting or stopping fraudulent, or abusive use of, or subscription to, 
...
(f) it is necessary for statistical counting, or for scientific research purposes, provided it is based on
...
(c) the nature of the electronic communications metadata, in particular where such data
    could reveal categories of data, pursuant to Article 9 of Regulation (EU) 2016/679;
...
(d) inform the end-user of specific processing on the basis of paragraph 2a and
    give the right to object to such processing free of charge, at any time, and in an
