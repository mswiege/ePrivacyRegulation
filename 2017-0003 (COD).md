...
(f) electronic communications data processed upon receipt by the end-users concerned or by a
    third party entrusted by the end-user for the purpose of protecting the end-user’s 
    in order to ensure the security of the end-user’s network and information systems including their terminal equipment.
...
(d) it is necessary for compliance with a legal obligation to which the provider is subject
    ...
    proportionate measure in a democratic society to safeguard public security
...
4. Union or Member state law may provide that the electronic communications metadata 
    is retained, in order to safeguar public security, for a limited period that is longer
...
5. The Board shall consult the supervisory authorities referred to in Article 18(0) before
    excercising any of the tasks referred to in paragraph 2
