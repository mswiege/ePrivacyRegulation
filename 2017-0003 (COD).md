...
3. The provisions of this Regulation particularise and complement Regulation (EU)
    2016/679 with regard to the processing of electronic communications data that qualify as
...
2. [Confidentiality of electronic communications data shall apply to the transmission of 
   machine-to-machine electronic communications where carried out via an electronic
...
2. Without prejudice to point (b) of Article 6(1) and points (a), (c) and (ce) of Article 6(2),
    ...
    for the purpose of the transmission of a communication. Such data may be recorded or
    stored by the end-users or by a third party entrusted by them to record, store or
    otherwise process such data, in accordance with Regulation (EU) 2016/679.
...
```
Article 8
Protection of information stored in terminal equipment of end-users and [related to or processed
by or emitted by] such equipment
```
...
(f) it is necessary to locate, at the time of the incident, a caller of an emergency call from the
    terminal by organisations dealing with emergency communications. 
...
2. Upon installation or first usage, the software  referred to in paragraph 1 shall inform the end-user about the privacy settings
    options and, to continue with the installation or usage, require the end-user to consent to a
    setting.
2a. The software referred to in paragraph 1 shall provide in a clear manner easy ways
    for end-users to change the privacy setting consented to under paragraph 2 at any
    time during the use.
...
```
Article 13
Exceptions to provide access to emeregency services
```
...
3. Regardless of whether the end-user has prevented access to the terminal equipment’s
    Global Navigation Satellite Systems (GNSS) capabilities through the terminal
    equipment settings, when a call is made to emergency services, such settings may not
    prevent access to GNSS data to determine and provide the caller location to
...
deploy state of the art measures to limit the reception of malicious or nuisance calls by end-users and shall
...
numbers using a specific code or prefix referred to in Article 16(3a);
...
```
1. The providers of number-based interpersonal communications services shall give end-users
    who are natural persons the opportunity to determine per category of personal data whether their
...
1a. The providers of number-based interpersonal communications services shall give end-
    users who are natural persons the means to verify, correct and delete data included in a publicly available
directory
2. The providers of number-based interpersonal communications services shall inform end-users who are
    ...
    functions of the directory and obtain the additional consent of end-users’ before enabling such search
...
3. The providers of number-based interpersonal communications services shall provide end-users that are legal
    ...
    directory.
3a. The providers of number-based interpersonal communications services shall give end-users that are legal persons the means to
...
2. Where a natural or legal person obtains contact details for electronic message
    ...
    collection and each time such direct marketing communication is [sent or presented].
...
6. Any natural or legal person using electronic communications services to [send or present]
    ...
    the communication is [sent or presented] and shall provide the necessary information for
    end-users who are natural persons to exercise their right to withdraw their consent, 
