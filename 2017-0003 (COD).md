...
provided that conditions laid down in Article 28 of Regulation (EU) 2016/679 are met;

(e) it is necessary for a security update provided that the privacy settings chosen by the
end-user are not changed in any way, the end-user is informed in advance and is
given the possibility to postpone or turn off the automatic installation of these
updates. 
