...
(e) electronic communications data after receipt processed by the end-user
    concerned, or by a third party entrusted by that end-user;

(f) electronic communications data before receipt processed by the end-users concerned or by a
    third party entrusted by the end-user for the purpose of ensuring network and 
...
(a) for the purpose of the provision of an service requested by an
    end-user for individual use if the requesting end-user has given consent and
...
(c) the nature of the electronic communications metadata as well as the modalities of the
    intended processing, in particular where such data or the intended processing
...
1. Without prejudice to points (b), (c) and (d) of Article 6(1) and of Article 6a,
    ...
    communication content by the intended recipient or recipients. Upon the end-user's
    explicit request the provider of the electronic communications service may store that
    end-user's electronic communications content as an integral part of the service as
    long as requested by the end-user. Such data may be processed in accordance with
    Article 6 and 6a.
...
```
Any end-user who has suffered material or non-
